...
const Partners = () => {
  ...
  return (
    <div className="container">
      {/* Partner logo */}
      <img src="./../../partners_limsa_logo.png" alt="" />
